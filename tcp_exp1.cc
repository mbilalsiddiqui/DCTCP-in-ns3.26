...
/****************** Data Transmission and receiving starts here *********************/
    ...
    uint16_t port = 9;
		...
		l = temp1;
												...
												ApplicationContainer sinkApps = sink.Install(c[1].Get(1));

												sinkApps.Start(Seconds(0.5));
												sinkApps.Stop(Seconds(20.0));

											for(int sender = 2; sender <14; sender++)
											{
												BulkSendHelper source("ns3::TcpSocketFactory",Address(InetSocketAddress(ip[1].GetAddress(1), port)));
